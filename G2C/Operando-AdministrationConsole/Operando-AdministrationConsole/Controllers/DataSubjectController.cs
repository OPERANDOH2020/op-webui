...
namespace Operando_AdministrationConsole.Controllers
{
    ...
    public class DataSubjectController : Controller
    {
        ...
        /*public ActionResult DataAccessLogs()
        {
            ...
            var jsonURL = String.Format("http://integration.operando.esilab.org:8091/operando/core/ldbsearch/log/search/?dateFrom&dateTo&logLevel&requesterType={0}&requesterId={1}&logPriority&title&keyWords", "USER", loggedUserId);
            ...
            // Stub an access log.
            DataAccessLog stubLogItem = createStubLogItem();
