...
namespace eu.operando.core.pdb.cli.Api
{
    ...
    public partial class PUTApi : IPUTApi
    {
        ...
        public ApiResponse<Object> OSPOspIdPrivacyPolicyPutWithHttpInfo (string ospId, OSPReasonPolicyInput ospPolicy)
        {
            ...
            if (ospId == null)
                throw new ApiException(400, "Missing required parameter 'ospId' when calling PUTApi->OSPOspIdPrivacyPolicyPut");
            // verify the required parameter 'ospPolicy' is set
            if (ospPolicy == null)
                throw new ApiException(400, "Missing required parameter 'ospPolicy' when calling PUTApi->OSPOspIdPrivacyPolicyPut");
