...
namespace eu.operando.core.pdb.cli.Api
{
    ...
    public partial class DELETEApi : IDELETEApi
    {
        ...
        public ApiResponse<Object> OSPOspIdPrivacyPolicyAccessReasonsReasonIdDeleteWithHttpInfo (string ospId, string reasonId)
        {
            // verify the required parameter 'ospId' is set
            if (ospId == null)
                throw new ApiException(400, "Missing required parameter 'ospId' when calling DELETEApi->OSPOspIdPrivacyPolicyAccessReasonsReasonIdDelete");
            // verify the required parameter 'reasonId' is set
            if (reasonId == null)
                throw new ApiException(400, "Missing required parameter 'reasonId' when calling DELETEApi->OSPOspIdPrivacyPolicyAccessReasonsReasonIdDelete");
