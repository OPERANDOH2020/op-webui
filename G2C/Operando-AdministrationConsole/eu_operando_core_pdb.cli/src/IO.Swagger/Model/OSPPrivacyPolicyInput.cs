...
namespace eu.operando.core.pdb.cli.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OSPPrivacyPolicyInput :  IEquatable<OSPPrivacyPolicyInput>, IValidatableObject
    {
        /// <summary>
        ...
        public OSPPrivacyPolicyInput(string PolicyText = default(string), string PolicyUrl = default(string), List<OSPDataRequest> Workflow = default(List<OSPDataRequest>), List<AccessPolicy> Policies = default(List<AccessPolicy>))
        {
