...
namespace eu.operando.core.pdb.cli.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OSPConsents :  IEquatable<OSPConsents>, IValidatableObject
    {
        /// <summary>
        ...
        public OSPConsents(string OspId = default(string), List<AccessPolicy> AccessPolicies = default(List<AccessPolicy>))
        {
            this.OspId = OspId;
