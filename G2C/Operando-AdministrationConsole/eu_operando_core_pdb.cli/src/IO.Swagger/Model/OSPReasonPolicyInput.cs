...
namespace eu.operando.core.pdb.cli.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OSPReasonPolicyInput :  IEquatable<OSPReasonPolicyInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OSPReasonPolicyInput" /> class.
        /// </summary>
        /// <param name="Policies">The list of access reasons to use a particular data subject types data .</param>
        public OSPReasonPolicyInput(List<AccessReason> Policies = default(List<AccessReason>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OSPReasonPolicyInput);
        }

        /// <summary>
        /// Returns true if OSPReasonPolicyInput instances are equal
        /// </summary>
        /// <param name="other">Instance of OSPReasonPolicyInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OSPReasonPolicyInput other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
