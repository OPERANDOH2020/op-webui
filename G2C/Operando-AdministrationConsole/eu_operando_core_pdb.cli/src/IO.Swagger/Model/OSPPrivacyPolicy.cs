...
namespace eu.operando.core.pdb.cli.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OSPPrivacyPolicy :  IEquatable<OSPPrivacyPolicy>, IValidatableObject
    {
        /// <summary>
        ...
        public OSPPrivacyPolicy(string OspPolicyId = default(string), string PolicyText = default(string), string PolicyUrl = default(string), List<OSPDataRequest> Workflow = default(List<OSPDataRequest>), List<AccessPolicy> Policies = default(List<AccessPolicy>))
        {
